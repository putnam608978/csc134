...
void organizing_the_defenses(); // the next sence
...
{
// TODO: Add your governor scene here!
...
cin >> choice;
if (choice == 1)
    cout << "Captain Lewis “nothing more then old superstitions no one is coming to save us we must surrender.” You respond to Captain Lewis “We cannot surrender we must fight to the last man. To surrender would be heresy!” Captain Lewis concedes your point and tells the Astropath to go and do his ancient rights. And tells you to take control of the defenses.  You respond “Yes sir!” and move outside to start coordinating your planets last stand." endl;
